...
public class CountryDetails extends AppCompatActivity {
    ...
    String str_countryName, str_confirmed, str_confirmed_new, str_active, str_active_new, str_death, str_death_new,
    ...
    private void GetIntent() {
        ...
        str_recovered_new=intent.getStringExtra(COUNTRY_RECOVERED_NEW);
    }
    private void Init() {
