...
import com.example.kiit.myapplication.Adapter.CountryWiseAdapter;
...
public class AffectedCountries extends AppCompatActivity{
    RecyclerView rv_country_wise;
    CountryWiseAdapter countryWiseAdapter;
     ArrayList<CountryWiseModal> countryWiseModelArrayList;
     SwipeRefreshLayout swipeRefreshLayout;
     EditText et_search;
     String str_country, str_confirmed, str_confirmed_new, str_active, str_active_new, str_recovered, str_recovered_new,
    ...
    private void Filter(String text) {
        ArrayList<CountryWiseModal> filteredList = new ArrayList<>();
        for (CountryWiseModal item : countryWiseModelArrayList) {
    ...
    private void Init() {
        ...
        countryWiseAdapter = new CountryWiseAdapter(AffectedCountries.this, countryWiseModelArrayList);
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            ...
                            for (int i=0;i<response.length(); i++){
                                ...
                                CountryWiseModal countryWiseModel  = new CountryWiseModal(str_country, str_confirmed, str_confirmed_new, str_active,
                                        str_death, str_death_new, str_recovered,str_recovered_new, str_tests, flagUrl);
                                //adding data to our arraylist
                                countryWiseModelArrayList.add(countryWiseModel);
                            }
                            Collections.sort(countryWiseModelArrayList, new Comparator<CountryWiseModal>() {
                                @Override
                                public int compare(CountryWiseModal o1, CountryWiseModal o2) {
